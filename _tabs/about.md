...
| **세종시 3단계 1-2차<br/> 스마트도시 구축용역**    | <b>사용자 위치 기반 도시정보 통합서비스 [세종엔](https://sejongn2.kr/) 개발</b> <br/><br/> [스마트맵 서비스](https://sejongn2.kr/m) 담당<br/>- 다양한 카테고리의 주변 정보 제공 <br/>- 외국인을 위한 다국어(영어/중국어/일어) 서비스 <br/>- 빠른 길찾기 기능<br/>- 실시간 버스 위치 서비스 <br/>- 느려진 랜더링을 개선하기 위한 목록 가상화 적용 <br/>- 마커 클러스터링 및 캔버스 활용 <br/>- [코드 스플릿팅을 통한 성능 개선 경험](https://gim224.github.io/posts/%EC%84%B1%EB%8A%A5%EA%B0%9C%EC%84%A0/) <br/><br/> `React` `Java` `Spring Framework` | 2021.10 ~ 2022.10 |
| **철도시설 이력관리<br/> 종합정보시스템 구축용역** | <b>DSS(의사지원시스템) 파트 개발</b><br/>- 점이력·선이력 등 이력DB 설계<br/>- 다양한 의사결정지원 알고리즘 시스템화 <br/><br/> `Java` `Spring Framework`                                                                                                                                                                                                                                                                                                                                                                                               | 2018.07 ~ 2021.09 |
| **김포도시철도<br/> IT설비(역무자동화)**           | <b>전산실 온습도 알리미 개발</b><br/><br/> `Python`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | 2018.03 ~ 2018.06 |

# 💭Personal Experience & Projects

| 프로젝트명                                                                                                                                                 | 내용                                                                                                                                                                            |                기간 |
| :--------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------: |
| [**수주내역 분석 프로그램**](https://gim224.github.io/posts/%EC%88%98%EC%A3%BC%EB%82%B4%EC%97%AD-%EB%B6%84%EC%84%9D-%ED%94%84%EB%A1%9C%EA%B7%B8%EB%9E%A8/) | <b>수주내역을 관리하고 분석하는 프로그램 개발</b><br/>- 수작업으로 30분 이상 걸리던 작업을 클릭 한 번으로 1분 내로 처리되도록 구현 <br/><br/> `Python`                          | 2023.11. ~ 2023.12. |
| [**온습도알리미**](https://drive.google.com/file/d/1ot-CxcZs-yZSOhPLMJsng5pzhMSD4ggt/view?usp=drive_link)                                                  | <b>전산실에 쓰일 온습도알리미 개발</b><br/>- 상용 온습도기 장치에 비해 훨씬 저렴한 가격으로 커스텀가능한 온습도 알림 기능 제공 <br/><br/> `Raspberry Pi` `Spring Boot` `Python` | 2018.06. ~ 2018.06. |
...
| 교육명                                                                                                                     | 내용                                                        |                             기간 |
| :------------------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------- | -------------------------------: |
| [**우아한테크캠프 Pro**](https://drive.google.com/file/d/1bmx0kEcOyKeeiEBJaTC7qEWNwe0m9n7p/view?usp=drive_link "nextstep") | 사설교육｜ 2기<br/>- 클린코드, TDD, JPA, 시스템 아키텍처 등 | 2021.5.17 ~ 2021.7.16 <br/> 수료 |
...
1. [Product-Minded Engineer; 제품 중심 개발자](https://www.integer.blog/product-minded-engineer/)
   ...
   - 문제를 해결하기 위해 개발 내외로 끊임없이 고민하는 사람이 될 것입니다!

2. [개발 교육자](https://youtu.be/ccXMdSM1IRo?si=CgDzUrCjs9p7z4xP)

   - 정답이 명확하지 않은 개발에서 최선책을 찾기 위해 정진하는 사람이 될 것입니다!
   - 서로가 같이 성장할 수 있는 환경을 만드는 사람이 될 것입니다!
